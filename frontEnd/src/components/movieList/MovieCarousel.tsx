...
const MovieCarousel = () => {
  ...
  const resetCategory = useResetRecoilState(movieCategoryState);
  const resetSort = useResetRecoilState(movieSortState);
          ...
          {images.map((image, index) => (
            ...
            >
              <div>
                ...
                <img
                  className="list-image w-[100%] h-[50vh] rounded-sm"
                  src={image.url}
                  alt=""
                />
              </div>

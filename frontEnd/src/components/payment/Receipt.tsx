...
const Receipt = () => {
  ...
  return (
    <div className="relative flex justify-center text-black">
      ...
      <div className="absolute top-[8vh]  w-[70%] flex flex-col gap-[8vh]">
      ...
      <button
        className="absolute bottom-[2.5vh] py-[2.5vh] text-[2.5vh] font-bold border-dashed border-t-[1px] border-t-black w-[88%] bg-transparent"
        onClick={() => navigate("/")}
      >
        확인
      </button>

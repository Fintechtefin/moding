...
public class MovieService {
    ...
    public List<Movie> searchMovie(String word) {
        //        return
        // transInfo(movieSearchCriteriaQueryRepository.findByCriteriaCondition(word));
    ...
    //        return
    // transInfo(movieSearchRepository.findByTitleContainingOrActorsContaining(keyword));
    //    }
